...
public class RestaurantServiceImpl implements RestaurantService {
    ...
    public RestaurantProfile saveRestaurant(Restaurants restaurant) throws Exception {
        ...
        RestaurantProfile restaurantProfile = new RestaurantProfile(restaurant.getUsername(),restaurant.getName(),restaurant.getEmail(),restaurant.getMobile(),restaurant.getAddress(),restaurant.getLocation(),restaurant.getCertificateNo(),restaurant.getCertificateName());
    ...
    @Override
    public RestaurantProfile displayRestaurant(String username) throws Exception {
